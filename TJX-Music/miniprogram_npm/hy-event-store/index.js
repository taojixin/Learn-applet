...
__DEFINE__(1670588366984, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1670588366985,"./event-store":1670588366986}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670588366985, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1670588366986, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1670588366985,"./utils":1670588366987}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670588366987, function(require, module, exports) {
...
return __REQUIRE__(1670588366984);
})()
